...
\begin{frame}{1. Data Analysis}
	...
	\textbf{G}enome \textbf{W}ide \textbf{A}ssociation \textbf{S}tudy \textbf{(GWAS)}: Multiple Sclerosis 
	\begin{center}
		%\bigskip
	\textcolor{red}{insert some pic about cases and control data with MS}
	\end{center}
	\btVFill
	\tiny \vspace{-\baselineskip}\color{berry}{Patsopoulos et al. 2013}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{1. Data Analysis}
	...
	\begin{center}
		...
		\includegraphics[width=\textwidth]{./figs/gwas_manhattan.jpg}
	\end{center}
	\btVFill
	\tiny \vspace{-\baselineskip}\color{berry}{Patsopoulos et al. 2013}
\end{frame}
