...
\begin{frame}{}
	...
	\btVFill
	\tiny \vspace{-\baselineskip}\color{berry}{Data from: European Molecular Biology Laboratory (EMBL)}
...
\begin{frame}{Not Just Biology!}
			...
			\pause
			\bigskip
			\textcolor{red}{insert some pic with chemestry here}\\
			\pause
			\textcolor{red}{insert pic about physics here}
			\column{.5\textwidth}
			\pause
			\centering
			\bigskip
			\textcolor{red}{insert facebook pic here}\\
			\textcolor{red}{insert instagram pic here}
		\end{columns}
...
\begin{frame}{Courses you should take or audit:}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\itm DataCamp, Corsera, CodeAcademy\textcolor{red}{insert more here! (and look up spelling of these)}
		\end{itemize}
